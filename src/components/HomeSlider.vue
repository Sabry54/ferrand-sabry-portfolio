<template>
  <div class="h-full overflow-x-auto snap-x snap-mandatory scroll-smooth">
    <!-- Container des slides -->
    <div class="flex h-full w-[400vw]">
      <!-- Slide 1 : Introduction -->
      <div
        class="w-screen h-full bg-gradient-to-br from-primary to-secondary p-8 flex items-center snap-start"
      >
      ...
      <!-- Slide 2 : Services -->
      <div
        class="w-screen h-full bg-gradient-to-br from-accent to-primary p-8 flex items-center snap-start"
      >
        <div class="container mx-auto text-white">
      ...
      <!-- Slide 3 : Portfolio -->
      <div
        class="w-screen h-full bg-gradient-to-br from-secondary to-accent p-8 flex items-center snap-start"
      >
        <div class="container mx-auto text-white">
      ...
      <!-- Slide 4 : Contact -->
      <div
        class="w-screen h-full bg-gradient-to-br from-primary to-accent flex flex-col snap-start"
      >
