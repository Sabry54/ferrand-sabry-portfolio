<template>
  <div class="slider-wrapper">
    ...
    <div v-if="isMobile">
      <!-- Slide 1 (mobile) -->
      <section
        class="w-full min-h-screen bg-[#BF4158] p-8 flex flex-col items-center justify-center"
      >
        <div class="text-white max-w-xl slide-content">
          <div class="rotating-title h-[80px] overflow-hidden">
            <div class="title-container">
              <h2 class="text-4xl font-bold font-limelight">Think</h2>
              <h2 class="text-4xl font-bold font-limelight">Build</h2>
              <h2 class="text-4xl font-bold font-limelight">Enhance</h2>
              <h2 class="text-4xl font-bold font-limelight">Engage</h2>
            </div>
          </div>
          <div class="mt-4 space-y-2">
            <p class="text-xl max-w-2xl">Thinking beyond the brief.</p>
        ...
        <div class="w-full flex justify-center mt-8">
          <img
            ...
            alt="Creative mascot"
            class="w-3/4 h-auto max-w-[200px] mx-auto"
          />
        </div>
      </section>
      <!-- Slide 2 (mobile) -->
      <section
        class="w-full min-h-screen bg-[#73CCB4] p-8 flex flex-col items-center justify-center relative overflow-hidden"
      >
        <img
          src="../assets/sanji-smoke.png"
          alt="Sanji smoking"
          class="absolute left-8 bottom-8 w-1/3 h-auto opacity-100 z-[8]"
        />
        <div class="container mx-auto text-white slide-content relative">
          <div class="relative z-[20]">
            <h2 class="text-5xl font-extrabold uppercase tracking-tighter mb-0">
              WELCOME
            </h2>
            <h3
              class="text-3xl font-extrabold uppercase tracking-tighter mt-0 mb-0"
            >
              TO MY PROJECT
            </h3>
          </div>
          <div class="relative z-[15]">
            <p class="text-base font-medium mt-16 mb-8">
          ...
          <div class="flex justify-center items-center mt-12 relative z-[25]">
            <router-link
              to="/about"
      ...
      <!-- Slide 3 (mobile) -->
      <section
        class="w-full min-h-screen bg-gradient-to-br from-secondary to-accent p-8 flex flex-col items-center justify-center"
      >
        <div class="container mx-auto text-white slide-content">
          <h2 class="text-6xl font-bold mb-8">Portfolio</h2>
      ...
      <!-- Slide 4 (mobile) -->
      <section
        class="w-full min-h-screen bg-gradient-to-br from-primary to-accent flex flex-col items-center justify-center p-8"
      >
        <div class="container mx-auto text-white slide-content">
          <h2 class="text-6xl font-bold mb-8">Let's Work Together</h2>
          <div class="max-w-xl">
    ...
    <div v-else>
      <!-- Ancien slider desktop/tablette inchangé -->
        ...
        >
          ...
          <div class="container mx-auto text-white slide-content relative">
            ...
            <div class="relative z-[15]">
              ...
              >
                This project is an exploration of vibe coding: a flexible,
                intuitive approach with no rigid roadmap—just moving forward
